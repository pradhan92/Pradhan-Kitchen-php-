                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-caption">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="price-tag ms-4"><small>Rs.</small>1026</span>
                                            </div>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-caption">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="price-tag ms-4"><small>RS</small>418.25</span>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>RS.</small>812.50</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>RS.</small>324.50</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <del class="ms-4"><small>RS.</small>650</del>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <del class="ms-4"><small>RS.</small>4124</del>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>RS.</small>520.50</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                ...
                                <div class="menu-info d-flex flex-wrap align-items-center">
                                    ...
                                    <span class="price-tag bg-white shadow-lg ms-4"><small>RS.</small>434.20</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="news-thumb mb-4">
                                <a href="/about">
                                    <img src="/assets//assets/images/news/pablo-merchan-montes-Orz90t6o0e4-unsplash.jpg" class="img-fluid news-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="news-thumb mb-4">
                                <a href="news-detail.html">
                                    <img src="/assets//assets/images/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg" class="img-fluid news-image" alt="">
                                </a>
                                ...
                                <div class="news-text-info news-text-info-large">
                                    ...
                                    <h5 class="news-title mt-2">
                                        <a href="/about" class="news-title-link">How to make a healthy meal</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="news-thumb mb-lg-0 mb-lg-4 mb-0">
                                ...
                                <div class="news-text-info">
                                    ...
                                    <h5 class="news-title mt-2">
                                        <a href="/about" class="news-title-link">Is Coconut good for you?</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
